...
| [security-audit.md](technical/security-audit.md) | **(Action report, 2026-06-03)** Source-level security + dead-code audit — write-capable warren ticket, VPN ingress spoofing, sandbox-bypass in transfer/MCP, secrets-at-rest KDF, vestigial code; severities + fixes + remediation plan |
