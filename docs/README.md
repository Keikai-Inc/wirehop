...
| [host-resilience.md](technical/host-resilience.md) | How a host detects that it is unreachable and restarts itself (inbound liveness probe, handshake deadlines, root-less `hop recover`), and how the client stops reusing a dead pooled connection |
