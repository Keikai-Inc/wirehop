...
#   curl -fsSL https://wirehop.org/install.sh | bash -s -- --version 0.1.0
#   curl -fsSL https://wirehop.org/install.sh | bash -s -- --dir ~/.local/bin
#   curl -fsSL https://wirehop.org/install.sh | bash -s -- --daemon
#
# Tiers:
...
BASE_URL="${HOP_CDN_URL:-https://wirehop.org}"
